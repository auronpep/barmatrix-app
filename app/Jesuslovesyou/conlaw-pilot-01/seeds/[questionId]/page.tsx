...
import { getConLawQuestionDetail } from "@/lib/jesuslovesyou/conlaw-question-details";
...
export async function generateMetadata({
  ...
  const detail = getConLawQuestionDetail(questionId);
  ...
  if (detail) {
    return {
      ...
      description: `${detail.title} answer-flow candidate for ConLaw-Pilot-01.`,
      alternates: {
        canonical: `/Jesuslovesyou/conlaw-pilot-01/seeds/${detail.questionId}`,
      },
    };
  }
...
export default async function ConLawSeedQuestionPage({
  ...
  if (detail) {
    const pilotCode = getConLawPilotCode(detail.selectorCode);
      ...
      <>
        <section className="hero">
          <div className="container">
            ...
            <div className="hero-actions" style={{ marginTop: 32 }}>
              ...
              <Link
                href={`${JESUSLOVESYOU_ROUTE_PREFIX}/conlaw-pilot-01/${detail.selectorCode}`}
                className="btn btn-lg ghost"
              >
        ...
        <section className="section">
          <div className="container">
            ...
            >
              {[
                ["Selector code", detail.selectorCode],
                ["Selected code", detail.outlineCode],
                ["Source code", detail.sourceOutlineCode],
                ["Public key", detail.key],
                ["Selector match", label(detail.selectorMatch)],

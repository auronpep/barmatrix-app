...
// Sample-data preview of the Briefing v2 (Full Command Deck) dashboard — lets
// you see the complete populated layout without Clerk auth / a live API. The real
// route is /preview/dashboard-v2 (signs in and pulls your live data). This demo
// mirrors that route's full layout with mock data and is self-contained so it
// never touches the v1 demo.
    ...
    <section className="mx-auto max-w-7xl px-6 py-10">
      <div className="mb-8 border-b border-zinc-900 pb-6">
        <p className="font-mono text-xs uppercase tracking-wider text-[var(--red)]">
          Briefing v2 · Demo (sample data)
        </p>
        <p className="mt-2 text-sm text-zinc-600">
          Sample data so you can see the full populated Briefing v2 layout. The
          real route{" "}
          <code className="font-mono text-zinc-900">/preview/dashboard-v2</code>{" "}
      ...
      <p className="mt-8 font-mono text-[11px] uppercase tracking-wider text-zinc-400">
        <Link href="/preview/dashboard" className="text-[var(--red)]">
          ← v1 Briefing
        </Link>
      </p>
    </section>

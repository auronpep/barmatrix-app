...
export default function CivilProcedureSubjectPage() {
  ...
  const startPractice = () => {
    ...
    if (questionIds.length === 0) {
      setPracticeError("Sync the Civil Procedure bank before starting practice.");
      return;
    }
    ...
    try {
      ...
      setPracticeError("This browser could not cache the Civil Procedure queue.");
      return;
    }
      ...
      <section className="hero">
        <div className="container">
          ...
          <p className="body-lg" style={{ marginBottom: 0, maxWidth: 760 }}>
            Civil Procedure practice starts from the live subject endpoint, then
          ...
          <div className="hero-actions" style={{ marginTop: 32 }}>
            ...
            >
              {phase === "loading" ? "Syncing bank" : "Sync Civil Procedure bank"}
            ...
            >
              Start Civil Procedure practice
            </button>
        ...
        <div className="container">
          ...
          >
            <div>
              ...
              {phase === "loading" && <StatusPanel title="Loading Civil Procedure bank" />}
            ...
            >
              ...
              <div className="forensics-body">
                ...
                >
                  Civil Procedure questions are routed by topic, procedural
                  posture, and tension point so the practice flow can isolate
                  recurring forum, jurisdiction, waiver, and timing traps.
                </p>
...
function IdlePanel({ onSync }: { onSync: () => void }) {
  return (
    <div className="info-panel">
      ...
      <p style={{ margin: 0, color: "var(--ink-soft)" }}>
        Load the first Civil Procedure page from the by-subject endpoint, review
...
function StatusPanel({ title }: { title: string }) {
  return (
    <div className="info-panel">
      ...
      <p style={{ margin: 0, color: "var(--ink-soft)" }}>
        Syncing the first Civil Procedure page from the subject endpoint.
      </p>
    </div>
  );
}
  ...
  if (questions.length === 0) {
    return (
      <div className="info-panel alert">
        <div className="eyebrow-strong" style={{ marginBottom: 12 }}>
          No Civil Procedure questions returned
        </div>
        <p style={{ margin: 0 }}>

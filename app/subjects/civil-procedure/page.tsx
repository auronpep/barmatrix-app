      ...
      <section className="hero">
        <div className="container">
          ...
          <p className="body-lg" style={{ marginBottom: 0, maxWidth: 760 }}>
            Civil Procedure practice starts from the live subject bank, then
...
function IdlePanel({ onSync }: { onSync: () => void }) {
  return (
    <div className="info-panel">
      ...
      <p style={{ margin: 0, color: "var(--ink-soft)" }}>
        Load the first Civil Procedure page from the subject bank, review
...
function StatusPanel({ title }: { title: string }) {
  return (
    <div className="info-panel">
      ...
      <p style={{ margin: 0, color: "var(--ink-soft)" }}>
        Syncing the first Civil Procedure page from the subject bank.
      </p>
    </div>
  );
}

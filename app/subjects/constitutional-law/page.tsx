...
export default function ConstitutionalLawSubjectPage() {
  ...
  const startPractice = () => {
    ...
    if (questionIds.length === 0) {
      setPracticeError("Sync the Constitutional Law bank before starting practice.");
      return;
    }
    ...
    try {
      ...
      setPracticeError("This browser could not cache the Constitutional Law queue.");
      return;
    }
      ...
      <section className="hero">
        <div className="container">
          ...
          <p className="body-lg" style={{ marginBottom: 0, maxWidth: 760 }}>
            Constitutional Law practice starts from the live subject endpoint,
            then hands the selected queue to the same answer and forensics
            runner used by the diagnostic flow.
          </p>
          <div className="hero-actions" style={{ marginTop: 32 }}>
            ...
            >
              {phase === "loading" ? "Syncing bank" : "Sync Constitutional Law bank"}
            ...
            >
              Start Constitutional Law practice
            </button>
        ...
        <div className="container">
          ...
          >
            <div>
              ...
              {phase === "loading" && <StatusPanel title="Loading Constitutional Law bank" />}
            ...
            >
              ...
              <div className="forensics-body">
                ...
                >
                  Constitutional Law questions are routed by topic, scrutiny
                  level, source of government action, and tension point so the
                  practice flow can isolate recurring rights, federalism, and
...
function IdlePanel({ onSync }: { onSync: () => void }) {
  return (
    <div className="info-panel">
      ...
      <p style={{ margin: 0, color: "var(--ink-soft)" }}>
        Load the first Constitutional Law page from the by-subject endpoint,
        review the returned queue, then start practice.
      </p>
      <button
        type="button"
        className="btn btn-sm red"
...
function StatusPanel({ title }: { title: string }) {
  return (
    <div className="info-panel">
      ...
      <p style={{ margin: 0, color: "var(--ink-soft)" }}>
        Syncing the first Constitutional Law page from the subject endpoint.
      </p>
    </div>
  );
}
  ...
  if (questions.length === 0) {
    return (
      <div className="info-panel alert">
        <div className="eyebrow-strong" style={{ marginBottom: 12 }}>
          No Constitutional Law questions returned
        </div>
        <p style={{ margin: 0 }}>

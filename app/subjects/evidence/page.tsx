...
export default function EvidenceSubjectPage() {
  ...
  const startPractice = () => {
    ...
    if (questionIds.length === 0) {
      setPracticeError("The Evidence question queue is empty.");
      return;
    }
    ...
    try {
      ...
      setPracticeError("This browser could not cache the Evidence practice queue.");
      return;
    }
      ...
      <section className="hero">
        <div className="container">
          ...
          <p className="body-lg" style={{ marginBottom: 0, maxWidth: 760 }}>
            Evidence practice starts from the live subject bank, then moves into
          ...
          <div className="hero-actions" style={{ marginTop: 32 }}>
            ...
            >
              Start Evidence practice <span className="arrow">-&gt;</span>
            </button>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="two-col" style={{ alignItems: "start" }}>
            <div>
              {phase === "loading" && <StatusPanel title="Loading Evidence bank" />}

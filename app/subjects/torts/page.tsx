...
const SUBJECT_FOCUS = {
  heading: "Torts Focus",
  label: "Duty, causation, liability theory, and scope",
  body:
    "Torts practice separates the recurring issue axes: intentional-tort elements, negligence duty and causation, strict or products liability theory, defamation or privacy classification, and party allocation.",
} as const;
...
export default function TortsSubjectPage() {
  ...
  const startPractice = () => {
    ...
    if (questionIds.length === 0) {
      setPracticeError("Sync the Torts bank before starting practice.");
      return;
    }
    ...
    try {
      ...
      setPracticeError("This browser could not cache the Torts queue.");
      return;
    }
      ...
      <section className="hero">
        <div className="container">
          ...
          <div className="hero-actions" style={{ marginTop: 32 }}>
            ...
            >
              {phase === "loading" ? "Syncing bank" : "Sync Torts bank"}
        ...
        <div className="container">
          ...
          <div className="two-col" style={{ alignItems: "start" }}>
            <div>
              ...
              {phase === "loading" && <StatusPanel title="Loading Torts bank" />}

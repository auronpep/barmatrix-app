...
describe("dashboard guided-path entry", () => {
  ...
  it("keeps the customer Atlas as a learning map with gated component lanes", () => {
    ...
    assert.match(atlas, /Learn the rule tested by \{selected\.code\}/);
    assert.match(atlas, /Prove it by completing/);
    assert.match(atlas, /Status: \{selectedStudied \? "studied" : "open"\}/);
    ...
    assert.match(atlas, /selectedMissingLanes/);
    assert.match(atlas, /Next gap/);
    assert.match(atlas, /add approved practice/);
    ...
    assert.match(atlas, /\{studiedCodeCount\} studied \/ \{nodes\.length\} codes/);
    assert.match(atlas, /lessonReadyCount/);
    assert.match(atlas, /\{readyCodeCount\} q-ready \/ \{lessonReadyCount\} lesson-ready/);
    assert.match(atlas, /laneReadyCount/);
    assert.match(atlas, /\{laneReadyCount\} lane-ready/);
    assert.match(atlas, /detourReadyCount/);
    assert.match(atlas, /\{detourReadyCount\} detour-ready/);
    ...
    assert.match(atlas, /scopedNextQuestionGapNode/);
    assert.match(atlas, /Next question gap/);
    assert.match(atlas, /scopedNextContentGapNode/);
    assert.match(atlas, /Next content gap/);
